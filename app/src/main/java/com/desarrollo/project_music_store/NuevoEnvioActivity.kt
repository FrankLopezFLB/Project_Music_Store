...
class NuevoEnvioActivity : AppCompatActivity(), AdapterView.OnItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var rutaServicioProd = "http://192.168.1.150/servicio/servicioEnvio/listar_productos.php"
        ...
        var rutaServicioCliente = "http://192.168.1.150/servicio/servicioEnvio/listar_clientes.php"
    ...
    fun grabarEnvio(v: View) {
        ...
        try {
            ...
            var rutaServicio = "http://192.168.1.150/servicio/servicioEnvio/nuevo_envio.php${parametros}"
